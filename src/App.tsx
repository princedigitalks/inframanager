...
import { LayoutGrid, Server, Briefcase, FileText, LogOut, Search, Bell, Settings, Plus, ChevronRight, Activity, Globe, Database, Shield, Monitor, HardDrive } from "lucide-react";
      ...
      <aside className="w-64 bg-white border-r border-[#E2E8F0] flex flex-col fixed h-full z-20">
        ...
        <nav className="flex-1 px-4 py-4 space-y-1">
          {[
            ...
            >
              <item.icon size={20} className={activeTab === item.id ? "text-[#2D31A6]" : "text-[#94A3B8] group-hover:text-[#64748B]"} />
